+++
title = "LAB 4 - Controllers and Views with Thymeleaf in Spring Boot"
description = "This lab presents the step-by-step process to create controllers and dynamic pages with Thymeleaf in a Spring Boot application."
date = "2026-03-26"
draft = false
author = "Enoque Leal"
...
In this lab, você vai aprender como criar controllers para processar dados e páginas dinâmicas usando Thymeleaf em uma aplicação Spring Boot. O objetivo é dar continuidade ao sistema de cadastro de carros, permitindo cadastrar e listar carros em páginas web.
...
## Task 2: Criando a Classe de Serviço (Service)
...
```
This method retorna todos os carros cadastrados.
...
This method adiciona um novo carro à lista, gerando um id único se necessário.
...
This method remove o carro com o id informado.
...
```
This method atualiza os dados do carro com o id informado.
...
## Task 2: Implementando o Controller
...
3. Injete o serviço responsável por salvar e buscar carros (`CarServiceImpl`). To do this, basta adicionar o parâmetro no construtor do controller:
...
## Task 3: Criando as Views com Thymeleaf
...
## Task 5: Próximos Passos

---

## Task 6: Implementando o CRUD REST na API

Além da interface web, é importante que sua aplicação também ofereça uma API REST para manipulação dos dados de carros. To do this, vamos editar a classe `IndexController` já existente no projeto e implementar os métodos do CRUD para a parte de API REST.
...
```
This method retorna todos os carros cadastrados em formato JSON.
...
```
This method cadastra um novo carro via API.
