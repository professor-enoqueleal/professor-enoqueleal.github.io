+++
title = "LAB 2 - Creating your First API with Spring Boot"
...
## Task 1: Criando o Projeto com o Spring Initializr
...
## Task 2: Adicionando as Dependências (Starters)
...
Adicione as seguintes dependências (type o nome no campo de busca):
...
## Task 3: Importando o Projeto na IDE e Criando o Controller
...
## Task 4: Executando e Testando a Aplicação
