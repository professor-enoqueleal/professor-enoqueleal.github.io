+++
title = "LAB 11 - Deploying to AWS with Amazon EC2"
description = "Simple tutorial: create EC2 with user-data that installs Git and Java, clones the repository, and starts the Spring Boot application in background using systemd." 
date = 2025-11-06
draft = true
author = "Enoque Leal"
...
In this lab vamos configurar o nosso projeto para fazer deploy em uma instância do **Amazon EC2**.
...
At the end, quando a instância estiver pronta a aplicação estará em execução e acessível pela porta 8080.
