+++
title = "LAB 7 - Database integration via JDBC - PART 1"
...
### Task 2: Configuração (H2 / DataSource para JDBC)

1. Open the file `application.properties`que fica no diretório ` (ou crie) ``carstore-spring-boot/src/main/resources`.
...
### Task 3: Implementando a conexão com JdbcTemplate
...
### Task 5: Implementar o CommandLineRunner (Opcional)
...
In this lab você adicionou H2, implementou um DAO com `JdbcTemplate`.
